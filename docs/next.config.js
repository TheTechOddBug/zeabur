...
export default withNextra({
  ...
  async redirects() {
    ...
    return templateRedirectsRule.concat([
      ...
      { source: '/operations/maintenance-mode', destination: '/operations/deployment/suspend-service', permanent: true },
      { source: '/:locale/operations/maintenance-mode', destination: '/:locale/operations/deployment/suspend-service', permanent: true },
      ...
      { source: '/es-ES/networking/high-availability', destination: '/es-ES/deploy/networking/high-availability', permanent: true },
      ...
      { source: '/ja-JP/networking/high-availability', destination: '/ja-JP/deploy/networking/high-availability', permanent: true },
