...
A newly created Team has **no Team plan subscribed** yet. Members cannot create projects, deploy templates, manage servers, or send emails through Z‑Send under the Team until the Team plan is activated.
