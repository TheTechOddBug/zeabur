...
| Pricing | Usage-based + subscription | [Subscription plan](/pricing) + server costs |

---

That's it. Your Railway application is now running on Zeabur. The two platforms have a very similar developer experience, so you should feel right at home. If you run into any issues, contact [Zeabur Support](https://zeabur.com/support).
