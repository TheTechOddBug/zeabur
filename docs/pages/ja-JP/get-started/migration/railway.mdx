...
| サーバー | 利用不可 | 利用可能（ベアメタルオプション） |
| テンプレート | Railway テンプレート | [Zeabur テンプレート](https://zeabur.com/templates) |
| 料金 | 使用量ベース + サブスクリプション | [サブスクリプションプラン](/pricing) + サーバー料金 |

---

以上です。Railway アプリケーションが Zeabur で稼働しています。両プラットフォームは非常に似た開発者体験を持っているため、すぐに慣れるはずです。問題が発生した場合は、[Zeabur サポート](https://zeabur.com/support)にお問い合わせください。
