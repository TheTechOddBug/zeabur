...
You need to create a template first to get a deploy button. You can create a template in [Zeabur Dashboard](https://zeabur.com/create-template).
...
Cuando alguien usa tu código de referido al comprar un Servidor, ganas una comisión escalonada (20%–100%) según tu nivel de referidos. Las comisiones se depositan en tu billetera y pueden convertirse en créditos de Zeabur para pagar tus servicios.
