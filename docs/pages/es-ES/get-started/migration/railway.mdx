...
| Precios | Basado en uso + suscripción | [Plan de suscripción](/pricing) + costos del servidor |

---

Listo. Tu aplicación de Railway ahora está ejecutándose en Zeabur. Ambas plataformas tienen una experiencia de desarrollador muy similar, así que deberías sentirte como en casa. Si encuentras algún problema, contacta con [Soporte de Zeabur](https://zeabur.com/support).
