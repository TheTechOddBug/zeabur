...
Un Equipo recién creado **no tiene aún el plan Team contratado**. Los miembros no pueden crear proyectos, desplegar plantillas, gestionar servidores ni enviar correos a través de Z‑Send dentro del Equipo hasta que se active el plan Team.
